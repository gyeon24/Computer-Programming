...
public class MonsterGame extends JFrame {
    ...
    class GamePanel extends JPanel {
        ...
        public GamePanel(String avatarChar, String monsterChar, char quitChar, long monsterDelay) {
            ...
            // TODO: 괴물을 움직이는 스레드(MonsterThread) 생성 및 시작
            Thread MonsterThread = new Thread(new MonsterThread(monster, avatar, monsterDelay));
            MonsterThread.start();
    ...
    class MonsterThread implements Runnable {         // TODO: 수정
        ...
        public void run() {
            ...
            while(true) {
                ...
                if (Math.abs(from.getX() - to.getX()) < 15 && Math.abs(from.getY() - to.getY()) < 15) {
                    System.exit(0);
                }

                // TODO: 괴물의 위치가 변경되었기 때문에 괴물을 포함하는 패널을 다시 그리도록 함
                from.getParent().repaint();

                // TODO: monsterDelay 동안 잠을 잔다.
                try {
